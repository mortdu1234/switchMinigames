execute unless score TowersGame timer matches 0 run scoreboard players remove TowersGame timer 1

execute as @a at @s run playsound minecraft:ui.loom.select_pattern master @s ~ ~ ~ 0.7 1.5
