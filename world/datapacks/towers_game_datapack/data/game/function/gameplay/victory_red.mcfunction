...
# EFFECTS
title @a subtitle [{text:"WINS",color:"red",bold:true}]
title @a times 1s 5s 1s
title @a title [{text:"TEAM RED",color:"dark_red",bold:true}]

execute as @a at @s run playsound minecraft:item.goat_horn.sound.0 master @s ~ ~ ~ 100 1.3
execute as @a at @s run summon minecraft:firework_rocket ~ ~1 ~ {LifeTime:20,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"large_ball",colors:[I;16711680,16755200],fade_colors:[I;16777215]}]}}}}
