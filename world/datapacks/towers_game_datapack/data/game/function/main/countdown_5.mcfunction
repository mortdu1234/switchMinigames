execute if score game game_countdown matches 1 run title @a subtitle [{text:"5",color:"green"}]
...
execute if score game game_countdown matches 1 run schedule function game:main/countdown_4 1s